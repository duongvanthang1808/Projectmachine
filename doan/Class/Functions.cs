...
namespace doan.Class
{
    class Functions
    {
        ...
        public static void Connect()
        {
            ...
            connString = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\duong_000\\Desktop\\doan\\doan\\Database\\Dulieubanmaytinh.mdf;Integrated Security=True;Connect Timeout=30";
        ...
        {
            if (Conn.State == ConnectionState.Open)// STATE LÀ TRẠNG THÁI
            {
