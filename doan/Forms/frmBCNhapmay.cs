...
{
    public partial class frmBCNhapmay : Form
    {
        ...
        string str;
        private void frmBCNhapmay_Load(object sender, EventArgs e)
        {
            int i;
            for (i = 1; i <= 12; i++)
        ...
        {
            string sql = "SELECT a.SoHDN, b.Mamay, a.MaNV, a.Ngaynhap, b.Slnhap, b.Dongianhap, b.Khuyenmai, b.Thanhtien FROM tblHoadonnhap AS a, tblChiTietHDN AS b WHERE a.SoHDN = b.SoHDN AND (MONTH(a.Ngaynhap)-1)/3 + 1 = " + cboQuy.Text + "AND YEAR(a.Ngaynhap)= " + cboNam.Text + "AND MONTH(a.Ngaynhap)= " + cboThang.Text;
            ...
            dvgBanHang.Columns[3].HeaderText = "Ngày nhập";
            ...
            {
                str = "SELECT SUM(TongTien) FROM tblHoadonnhap WHERE (MONTH(Ngaynhap)-1)/3 + 1 = " + cboQuy.Text + "AND YEAR(Ngaynhap)= " + cboNam.Text;
        ...
        private void btnIn_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["C2:F2"].Value = "BÁO CÁO THỐNG KÊ NHẬP HÀNG ";
            ...
            exRange.Range["I8:I8"].ColumnWidth = 22;
            ...
            exRange.Range["B8:B8"].Value = "Số hóa đơn nhập";
            exRange.Range["C8:C8"].Value = "Mã máy";
            exRange.Range["D8:D8"].Value = "Mã nhân viên";
            exRange.Range["E8:E8"].Value = "Ngày bán";
            exRange.Range["F8:F8"].Value = "Số lượng";
            exRange.Range["G8:G8"].Value = "Đơn giá";
            exRange.Range["H8:H8"].Value = "Giảm giá(%)";
            exRange.Range["I8:I8"].Value = "Thành tiền(đv:đồng)";
            //exRange.Range["J8:J8"].Value = "Thành tiền(đv:đồng)";
            exRange.Range["A8:J8"].Borders.Color = Color.Black;

            for (hang = 0; hang <= tblNhapHang.Rows.Count - 1; hang++)
            {
                ...
                for (cot = 0; cot <= tblNhapHang.Columns.Count - 1; cot++)
                    // Dien thong tin tu cot thu 2, dong 9
                    exSheet.Cells[cot + 2][hang + 9] = tblNhapHang.Rows[hang][cot].ToString();
            }
